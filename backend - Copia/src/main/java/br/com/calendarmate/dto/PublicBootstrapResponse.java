<<<<<<< HEAD:backend/src/main/java/br/com/calendarmate/dto/PublicBootstrapResponse.java
...
public class PublicBootstrapResponse {
>>>>>>> origin/FRONTEND:backend/src/main/java/com/example/Calendar/dto/PublicBootstrapResponse.java
...
=======
        private List<Integer> allowedMinuteMarks = new ArrayList<>();
        private int maxFutureMonthsAhead;
        private long pendingTtlSeconds;
        private boolean blockOtherBookingsWhenPending;
        ...
        public void setAllowedMinuteMarks(List<Integer> allowedMinuteMarks) { this.allowedMinuteMarks = allowedMinuteMarks; }
        public int getMaxFutureMonthsAhead() { return maxFutureMonthsAhead; }
        public void setMaxFutureMonthsAhead(int maxFutureMonthsAhead) { this.maxFutureMonthsAhead = maxFutureMonthsAhead; }
...
=======
    ...
    public BookingConfig getBooking() { return booking; }
    public void setBooking(BookingConfig booking) { this.booking = booking; }
