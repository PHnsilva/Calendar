...
export function buildAdminMockBookings(anchor = new Date()): ServicoResponse[] {
  ...
  const future = [
    ...
    { day: 11, time: '11:00', name: ['Fernanda', 'Lima'], city: 'Nova Lima', service: 'Instalação', street: 'Alameda dos Ipês', number: '103' },
    { day: 15, time: '15:00', name: ['João', 'Pedro'], city: 'Belo Horizonte', service: 'Manutenção', street: 'Av. Afonso Pena', number: '104' },
    { day: 18, time: '08:30', name: ['Lucas', 'Oliveira'], city: 'Itabirito', service: 'Preventiva', street: 'Rua Barão de Itabirito', number: '55' },
    { day: 22, time: '13:00', name: ['Marina', 'Costa'], city: 'Congonhas', service: 'Vistoria técnica', street: 'Rua da Matriz', number: '77' },
  ...
  const past = [
    ...
    { offsetMonth: -1, day: 11, time: '10:30', name: ['Eduarda', 'Torres'], city: 'Ouro Preto', service: 'Manutenção', street: 'Rua Direita', number: '102' },
    { offsetMonth: -1, day: 15, time: '11:00', name: ['Fernanda', 'Lima'], city: 'Nova Lima', service: 'Preventiva', street: 'Alameda dos Ipês', number: '103' },
    { offsetMonth: -1, day: 17, time: '14:00', name: ['Lucas', 'Oliveira'], city: 'Congonhas', service: 'Visita técnica', street: 'Rua Barão de Congonhas', number: '201' },
